...
import Solicitud_empleados from "./Gestionar_expedientes/solicitud_empleados";
...
export default function Home() {
  ...
  const items = [
    ...
    {
      label: "Consultar Desembolsos",
      icon: "pi pi-wallet",
      command: () => setActivePage("solicitud_empleados"),
    },
    {
    ...
    <>
      ...
      <main className={`${styles.main} ${inter.className}`}>
        ...
        <div>
          ...
          {activePage === "solicitud_empleados" && <Solicitud_empleados />}
